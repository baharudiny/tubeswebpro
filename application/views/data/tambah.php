...
<div class="container">
	<div class="row mt-3">
		<div class="col-md-6">
			<div class="card">
				  <div class="card-header">Form Tambah Data Makanan</div>
				  <div class="card-body">
				  	<form action="" method="post">
				    	<div class="form-group">
 				 		...
 				 		<div class="form-group">
    						...
    						<input type="text" name="jenismakanan" class="form-control" id="jenismakanan">
    						<small class="form-text text-danger"></small>
 				 		</div>
						<div class="form-group">
    						<label for="komposisi">komposisi</label>
    						<input type="text" name="komposisi" class="form-control" id="komposisi">
    						<small class="form-text text-danger"></small>
  						</div>
